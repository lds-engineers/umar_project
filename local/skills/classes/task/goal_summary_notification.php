 ...
 */
class goal_summary_notification extends \core\task\scheduled_task {
    ...
    public function get_name(){
        return "Goal Summary Notification";
    }
    ...
    public function execute() {
        ...
        //echo $currentDate;
        $notification_id="goal_summary_notification";
        ...
        $block_skill_list_goal_summary_notification_day=$CFG->block_skill_list_goal_summary_notification;
        if($val==$block_skill_list_goal_summary_notification_day){
     ...
     //  echo  get_config('block_skill_list', 'block_skill_list_goal_not_set_notification');
        ...
        if(!empty($usergoal_data)){
        	foreach($usergoal_data as $list){
                ...
                $message->smallmessage      = "Weekly Goal summary";//get_string('notification_message_subject', 'local_moodleoverflow',$a);
                $message->subject           = 'Weekly Goal Summary ('.date('d-M-Y').')';//get_string('notification_message_subject', 'local_moodleoverflow',$a);
                $message->fullmessage       = "Weekly Goal Summary Notification";//get_string('smeinviteemail', 'local_moodleoverflow',$a);
                $message->fullmessagehtml   = "<h1>Weekly Goal Summary Notification</h1>".$msgdata;//get_string('smeinviteemail', 'local_moodleoverflow',$a);
