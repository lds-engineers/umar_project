...
global $DB,$USER,$CFG;
    ...
    if(!empty($course_asign_data)){
      ...
      if(!empty($course_data)){
      	$course_url=$CFG->wwwroot.'/blocks/skill_list/course_details.php?id='.$course_data->id.'&skill_id='.$skill_id;
        ...
        if(!empty($course_com_data)){
          ...
          $coursedata.='  <div class="col-4 custom_padding"> 
            <div class="course_card">
              <div>
                <a href="'.$course_url.'">
                  <div>
                    <img src="'.$image_url.'" alt=""> '.$course_com.'
                  </div>
